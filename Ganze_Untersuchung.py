...
dpath = '/home/dbeier/reegis/data/feedin/de21_region/2014/'
dfile_wind = os.path.join(dpath,'2014_feedin_de21_region_normalised_wind.csv')
test = pd.read_csv(dfile_wind)

wind_norm_de21=pd.DataFrame[]
for i in range (1,21):




sc.table_collection['time_series'].DE01.wind
